...
export const listBoxOptionContainerStyle = classNames(
  'group flex relative cursor-default select-none', // behavior
...
export const listBoxOptionItemStyle =
  'truncate flex-shrink-0 font-normal text-gray-900 group-focus:text-white group-data-[selected]:font-bold group-data-[disabled]:text-gray-400';
export const listBoxOptionDescriptionStyle =
  'ml-2 truncate truncate text-gray-500 group-focus:text-indigo-200 group-data-[disabled]:text-gray-400';
